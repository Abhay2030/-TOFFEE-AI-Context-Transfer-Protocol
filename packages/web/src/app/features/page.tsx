    ...
    <div className="min-h-screen bg-navy-950 pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-20">
          ...
          <GlassCard className="p-8 group hover:border-toffee-500/30 transition-all">
          ...
          <GlassCard className="p-8 group hover:border-accent-violet/30 transition-all">
          ...
          <GlassCard className="p-8 group hover:border-accent-emerald/30 transition-all">
          ...
          <GlassCard className="p-8 group hover:border-toffee-400/30 transition-all">
        ...
        {/* Creator Note */}
        <GlassCard className="mt-20 p-10 text-center max-w-4xl mx-auto border-toffee-500/20 relative overflow-hidden">
